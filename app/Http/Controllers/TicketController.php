...
class TicketController extends Controller
{
    ...
    public function complete(Request $request, Ticket $ticket)
    {
        ...
        $validated = $request->validate([
            ...
            'user_id_number' => 'nullable|string|max:255',
            'location' => 'nullable|string|max:500',
            'user_phone' => 'nullable|string|max:20',
            'user_email' => 'nullable|email|max:255',

            // Case Details
            'unit_type' => 'nullable|in:Desktop,Laptop,Printer,Projector,Scanner,Monitor,Other',
            'category' => 'nullable|in:Incident,Request',
            'scope' => 'nullable|in:Maintenance Support,Void,Out of Scope',
            'warranty_status' => 'nullable|in:Warranty,Out of Warranty',
            'case_description' => 'nullable|string',

            // Work Information
            'work_notes' => 'nullable|string',
            'solution_category' => 'nullable|in:Repair,Re/Install,Reimage,Pemindahan Data,Other',

            // Parts
            'replaced_parts' => 'nullable|array',
            'replaced_parts.*.quantity' => 'nullable|string',
            'replaced_parts.*.description' => 'nullable|string',
            'replaced_parts.*.part_number' => 'nullable|string',
            'replaced_parts.*.serial_number' => 'nullable|string',

            // Visit & Resolution
            'visit_date' => 'nullable|date',
            'visit_time' => 'nullable|string',
            'resolved_date' => 'nullable|date',
            'resolved_time' => 'nullable|string',
     ...
     * Download BAP PDF
     */
    public function downloadBap(Ticket $ticket, BapService $bapService)
    {
        return $bapService->downloadBap($ticket);
    }

    /**
     * Preview BAP PDF
     */
    public function previewBap(Ticket $ticket, BapService $bapService)
    {
        return $bapService->streamBap($ticket);
    }
}
