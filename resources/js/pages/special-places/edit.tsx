...
const breadcrumbs = (specialPlace: SpecialPlaceResource): BreadcrumbItem[] => [
    ...
    { title: 'Special Places', href: specialPlacesRoutes.index.url() },
    {
        ...
        href: specialPlacesRoutes.edit.url({ special_place: specialPlace.id }),
    },
];

export default function SpecialPlaceEdit({
    specialPlace,
    provinces,
    engineers,
}: Props) {
    ...
    const handleDelete = () => {
        if (confirm(`Remove ${specialPlace.name} from Special Places?`)) {
            router.delete(
                specialPlacesRoutes.destroy.url({
                    special_place: specialPlace.id,
                }),
            );
        }
    };
    ...
    const selectedEngineer = engineers.find(
        (engineer) => engineer.id === data.engineer_id,
    );
        ...
        <AppLayout breadcrumbs={breadcrumbs(specialPlace)}>
            ...
            <div className="space-y-6 pb-10">
                <section className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 shadow-lg starting:translate-y-4 starting:opacity-0">
                    <div className="bg-[radial-gradient(circle_at_top,_theme(colors.primary/12),_transparent_70%)] absolute inset-0 -z-10" />
                    <div className="flex flex-wrap items-start justify-between gap-6">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                                Keep location, contact, and assignment details
                                aligned so field teams have the latest context.
                            </p>
                        </div>
                        ...
                        {[
                            {
                                title: 'Profile',
                                description:
                                    'Refresh location and onsite contact details.',
                                icon: ClipboardEdit,
                            },
                            {
                                title: 'Coverage',
                                description: selectedEngineer
                                    ? `Assigned to ${selectedEngineer.name}`
                                    : 'No engineer assigned yet.',
                                icon: MapPin,
                            },
                            {
                                title: 'Status',
                                description: specialPlace.is_active
                                    ? 'Currently active'
                                    : 'Inactive location',
                                icon: Sparkles,
                            },
                    ...
                    <div className="space-y-6">
                        <Card className="border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Keep details current so every visit starts
                                    smoothly.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2 md:col-span-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Update key instructions, security details, or escalation paths."
                                    />
                        ...
                        <Card className="border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Ensure the latest snapshot before saving
                                    changes.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Inactive locations are hidden from
                                            active dashboards.
                                        </p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    ...
                                    <Link
                                        href={specialPlacesRoutes.index.url()}
                                    >
                                        <Button
                                            type="button"
                                            variant="outline"
                    ...
                    <aside className="space-y-6">
                        <Card className="sticky top-28 border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Quick view of the engineer responsible for
                                    this site.
                                </CardDescription>
                            </CardHeader>
                                ...
                                {selectedEngineer ? (
                                    <>
                                        ...
                                        <p className="text-muted-foreground">
                                            Reach out via engineer directory for
                                            more context or schedule
                                            coordination.
                                        </p>
                                        <Link
                                    ...
                                    <p className="text-muted-foreground">
                                        No engineer assigned yet. Assign one to
                                        streamline on-site coordination.
                                    </p>
                                )}
                            </CardContent>
                        </Card>
