                    ...
                    <div className="flex flex-wrap items-start justify-between gap-6">
                        <div className="space-y-4">
                            ...
                            <h1 className="text-3xl font-bold sm:text-4xl">
                                Register a New Strategic Location
                            </h1>
                            <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                                Centralize key customer sites, assign an
                                engineer, and store onsite contact details for
                                quick dispatch.
                            </p>
                        </div>
                        ...
                        {[
                            {
                                ...
                                description:
                                    'Name, city, and on-site address details.',
                                icon: MapPin,
                            },
                            {
                                title: 'Engineer Assignment',
                                description:
                                    'Choose an engineer to own the relationship.',
                                icon: ClipboardList,
                            },
                            {
                                title: 'Activation',
                                description:
                                    'Toggle whether the site is currently monitored.',
                                icon: Sparkles,
                            },
                        ].map((item) => (
                            <div
                    ...
                    <div className="space-y-6">
                        <Card className="border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Store essential information for the field
                        ...
                        <Card className="border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Review snapshot before saving the Special
                                    Place.
                                </CardDescription>
                            </CardHeader>
                                ...
                                <div className="flex items-center justify-between rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Inactive locations remain hidden
                                            from dashboards and schedules.
                                        </p>
                                    </div>
                                    <Switch
                    ...
                    <aside className="space-y-6">
                        <Card className="sticky top-28 border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Jump to the engineer directory to create a
                                    new contact if required.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4 text-sm text-muted-foreground">
                                <p>
                                    • Assigning an engineer ensures
                                    accountability when incidents happen.
                                </p>
                                <p>
                                    • Capture the onsite PIC to accelerate
                                    coordination for multi-visit workflows.
                                </p>
                                <p>
                                    • Use notes for details like building
                                    passes, security codes, and service hours.
                                </p>
                            </CardContent>
                        </Card>
                    </aside>
