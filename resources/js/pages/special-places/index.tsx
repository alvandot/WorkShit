...
export default function SpecialPlacesIndex({
    specialPlaces,
    filters,
    provinces,
    stats,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 pb-10">
                <section className="flex flex-col gap-4 rounded-3xl border border-primary/15 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 md:flex-row md:items-center md:justify-between starting:translate-y-3 starting:opacity-0">
                    <div className="space-y-2">
                        ...
                        <h1 className="text-3xl font-bold sm:text-4xl">
                            Manage Strategic Customer Sites
                        </h1>
                        <p className="text-sm text-muted-foreground">
                            Coordinate coverage, track onsite contacts, and
                            ensure each Special Place has an assigned engineer.
                        </p>
                    </div>
                ...
                <Card className="border border-border/60">
                    <CardHeader className="space-y-1">
                        ...
                        <CardDescription>
                            Refine Special Places by status, province, or
                            contact details.
                        </CardDescription>
                    </CardHeader>
                                ...
                                <SelectContent>
                                    ...
                                    {provinces.map((provinceOption) => (
                                        <SelectItem
                                            ...
                                            value={String(provinceOption.id)}
                                        >
                                            {provinceOption.name}
                                        </SelectItem>
                                    ))}
                ...
                <Card className="border border-border/60">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Visibility into coverage, contacts, and onsite
                                assignments.
                            </CardDescription>
                        </div>
                        <Badge
                                ...
                                {specialPlaces.data.map((place) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-right text-sm font-medium">
                                            <Link
                                                href={specialPlacesRoutes.edit.url(
                                                    { special_place: place.id },
                                                )}
                                                className="text-primary hover:underline"
                                            >
                                                Edit
