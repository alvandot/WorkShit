                ...
                <section className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 shadow-lg starting:translate-y-4 starting:opacity-0">
                    ...
                    <div className="mt-6 grid gap-3 md:grid-cols-3">
                        {[
                            ...
                            <div key={item.title} className={cn("rounded-2xl border border-white/20 bg-background/70 p-4 shadow-sm backdrop-blur", currentStep === item.step ? "border-primary/50 bg-primary/5" : "")}>
                                <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Add specialization and experience details.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-2">
