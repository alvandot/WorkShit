                    ...
                    <div className="flex flex-wrap items-start justify-between gap-6">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                                Capture profile details, assign a primary
                                province, and set the engineer&apos;s
                                availability for special place dispatching.
                            </p>
                        </div>
                    ...
                    <div className="mt-6 grid gap-3 md:grid-cols-3">
                        {[
                            ...
                            },
                            {
                                title: 'Coverage',
                                description:
                                    'Assign a primary province to streamline dispatch.',
                                icon: UserCheck,
                                step: 2,
                            },
                            {
                                title: 'Availability',
                                description:
                                    'Toggle if the engineer is ready for field work.',
                                icon: Sparkles,
                                step: 2,
                            },
                        ].map((item) => (
                            <div
                                key={item.title}
                                className={cn(
                                    'rounded-2xl border border-white/20 bg-background/70 p-4 shadow-sm backdrop-blur',
                        ...
                        {currentStep === 1 && (
                            <Card className="border border-border/60">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Keep engineer information complete to
                                        coordinate quickly with field teams.
                                    </CardDescription>
                                </CardHeader>
                            ...
                            <>
                                ...
                                <Card className="border border-border/60">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Toggle engineer readiness and share
                                            onboarding summary before saving.
                                        </CardDescription>
                                    </CardHeader>
                                        ...
                                        <div className="flex items-center justify-between rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4">
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    Inactive engineers will be
                                                    hidden from Special Place
                                                    assignment lists.
                                                </p>
                                            </div>
                                            <Switch
                    ...
                    <aside className="space-y-6">
                        <Card className="sticky top-28 border border-border/60">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Ensure the engineer profile is as complete
                                    as possible for smoother scheduling.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-3 text-sm text-muted-foreground">
                                <p>
                                    • Employee code helps cross-reference with
                                    HRIS records.
                                </p>
                                <p>
                                    • Select the primary province to surface the
                                    engineer in Special Place forms.
                                </p>
                                <p>
                                    • Use notes to capture certifications,
                                    languages, or access cards.
                                </p>
                            </CardContent>
                        </Card>
                    </aside>
