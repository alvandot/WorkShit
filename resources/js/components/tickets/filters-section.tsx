...
import { Layers, LineChart, ListChecks, Radar, RefreshCcw } from 'lucide-react';
...
export const FiltersSection = memo(
    ({ tickets, status, onStatusFilter }: FiltersSectionProps) => {
                    ...
                    {quickStatusFilters.map((filterOption) => {
                        ...
                        return (
                            <Button
                                ...
                                className="gap-2"
                                onClick={() =>
                                    onStatusFilter(filterOption.value)
                                }
                            >
